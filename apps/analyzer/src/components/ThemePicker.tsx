      ...
      <AnimatePresence>
        {isOpen && (
          <motion.div
            ...
            className='absolute bottom-16 xl:bottom-28 right-0 bg-surface-container-high text-on-surface rounded-3xl p-4 shadow-elevation-2 hover:shadow-elevation-3 w-72 font-sans'
          >
